...
export default function SettingsScreen() {
  ...
  // Initialize temp company name when branding loads
  useEffect(() => {
    if (brandingSettings.customName) {
      setTempCompanyName(brandingSettings.customName);
    }
  ...
  const handleCompanyNameUpdate = async () => {
    try {
      await updateCompanyName(tempCompanyName);
      ...
      <FormSection title="Company Branding">
        ...
        <View style={styles.brandingPreview}>
          ...
          <View style={styles.brandingPreviewContent}>
            {companyInfo.logoUri ? (
              <Image source={{ uri: companyInfo.logoUri }} style={styles.logoPreview} />
            ) : (
        ...
        <View style={styles.settingRowVertical}>
          ...
          <View style={styles.companyNameInput}>
            ...
            <TouchableOpacity
              ...
              onPress={handleCompanyNameUpdate}
              disabled={!tempCompanyName.trim() || brandingLoading}
            >
